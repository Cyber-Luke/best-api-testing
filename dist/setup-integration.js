...
async function setupIntegration() {
    ...
    if (!existsSync(packageJsonPath)) {
        ...
        console.log(chalk.gray("This script should be run in the root of your project"));
        process.exit(1);
    }
    ...
    writeFileSync(path.join(targetDir, "integration-tests.tsconfig.json"), JSON.stringify(integrationTsConfig, null, 2));
    // Create config file
    const defaultConfig = {
    ...
    writeFileSync(path.join(targetDir, "integration-test.config.json"), JSON.stringify(defaultConfig, null, 2));
    // Create example test
...
`;
    ...
    console.log(chalk.cyan("   1. npm install --save-dev github:Cyber-Luke/best-api-testing"));
    console.log(chalk.cyan("   2. Edit integration-test.config.json with your GraphQL endpoint"));
